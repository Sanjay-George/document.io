...
A companion app is required to add and view annotations on websites. It lives in this repo under [`companion/`](./companion) — [you can set it up from here.](./companion/README.md#-quick-start)
